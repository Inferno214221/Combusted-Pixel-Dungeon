...
//		add_v1_0_Changes(changeInfos);
	...
	public static void add_v1_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new Image(Assets.Environment.TERRAIN_FEATURES, 112, 112, 16, 16), new Mageroyal().name(),
	...
	public static void add_v1_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		ChangeInfo changes = new ChangeInfo("v1.0 (WIP)", true, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
	...
	public static void add_v0_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		ChangeInfo changes = new ChangeInfo("v0.1 (WIP)", true, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CBPX), "Developer Commentary",
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.MAGIC_INFUSE), "New Art For Spells & Elixirs",
				"Updated the spell icons to be similar to scrolls but in a different color.\n\n" +
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POUCH, null), "Hero Starting Inventory Bag",
				"The starting inventory expansions have been adjusted for each hero.\n\n" +
						"_Warrior_ and _Rouge_ start with magical holsters.\n\n" +
