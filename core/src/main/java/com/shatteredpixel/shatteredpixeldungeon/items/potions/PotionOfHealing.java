...
public class PotionOfHealing extends Potion {
	...
	public static void heal( Char ch ){
		if (ch == Dungeon.hero && Dungeon.isChallenged(Challenges.NO_HEALING)){
			...
			Buff.affect(ch, Healing.class).setHeal((int) (((0.8f + (0.1f * Dungeon.hero.pointsInTalent(Talent.POTION_DURATION))) * ch.HT) + 14), (0.25f - (0.5f * Dungeon.hero.pointsInTalent(Talent.POTION_DURATION))), 0);
			if (ch == Dungeon.hero){
